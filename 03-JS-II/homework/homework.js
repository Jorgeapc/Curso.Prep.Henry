...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1 === 0 || num2 === 0 || num3 === 0) { return "Error" }
          ...
          else if (num3 > num2 && num3 > num2 ) { return num3 = num3 + 1 }
             else { return false }
}
...
function esPrimo(numero) {
  ...
  //console.log( "Numero / numero el modulo es ") 
  //console.log(numero)
  //console.log( numero%numero === 0)
  //console.log( "numero / 1 el modulo es ") 
  //console.log( numero % 1 === 0)
  //if (numero%2 === 1 && numero % 1 === 0 && numero > 1) { 
  //  console.log("Debe ser primo " + numero)
  //  return true }
  //  else if ( numero === 0 || numero === 1) { 
  //    console.log( "0 o 1 " + numero)
  //    return false }
  //     else { 
  //      console.log("Debe ser no primo " + numero) 
  //      return false}
  if(numero < 2){
    return false;
    } 
